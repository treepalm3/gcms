<?php
// manager/committee.php — จัดการกรรมการ (รองรับแผนก แยกจากตำแหน่ง) สำหรับผู้บริหาร
session_start();
...
/* ---------- Role (ให้สิทธิ์ manager และ admin) ---------- */
try {
...
try {
  if (table_exists($pdo,'settings')) {
    // อ่าน station_id + comment เป็นชื่อหน่วยงาน (ให้เหมือนหน้า manager อื่น ๆ)
