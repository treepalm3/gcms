<?php
// manager/report.php — ระบบรายงานและสถิติ (สำหรับผู้บริหาร)
...
// ==== หา column วันที่แบบยืดหยุ่น (สำรอง) ====
...
<head>
  ...
  <title>รายงานและสถิติ | <?= htmlspecialchars($site_name) ?></title>
...
<!-- Footer -->
<footer class="footer">© <?= date('Y') ?> <?= htmlspecialchars($site_name) ?> — รายงานและสถิติ</footer>
