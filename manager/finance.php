<?php
// manager/finance.php — จัดการการเงินและบัญชี (ปรับปรุงเหมือน Admin)
session_start();
...
try {
  ...
  // *** เปลี่ยนจาก 'admin' เป็น 'manager' ***
  if ($current_role !== 'manager') { header('Location: /index/login.php?err=คุณไม่มีสิทธิ์เข้าถึงหน้านี้'); exit(); }
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar">
  ...
  <div class="offcanvas-body sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <a href="finance.php" class="active"><i class="bi bi-wallet2"></i> การเงินและบัญชี</a>
