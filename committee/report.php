<?php
// committee/report.php — รายงานและสถิติ (สไตล์เดียวกับ admin/report.php)
...
try {
  ...
  // ใช้ join กับ fuel_prices ถ้า sales_items อ้างอิงเป็น id ได้จริง
...
<head>
  ...
  <title>รายงานและสถิติ | <?= h($site_name) ?></title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-lg-10 p-4">
      ...
      <!-- Filter Section (UI เท่านั้น—ยังไม่ POST) -->
                ...
                <div class="table-responsive">
                  <table class="table table-hover align-middle">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><strong><?= h($stock['fuel_type']) ?></strong></td>
...
<!-- Footer -->
<footer class="footer">© <?= date('Y') ?> <?= h($site_name) ?> — รายงานและสถิติ</footer>
...
new Chart($('#fuelTypeChart').getContext('2d'), {
  type: 'doughnut',
  data: {
...
new Chart($('#monthlyFinanceChart').getContext('2d'), {
  type: 'bar',
  data: {
...
// Stock Status Chart
new Chart($('#stockStatusChart').getContext('2d'), {
  type: 'bar',
  data: {
