<?php
// admin/profit_report.php — รายงานกำไรคงเหลือในถัง
session_start();
...
try {
    ...
    // อนุญาตให้ Admin หรือ Manager ดูหน้านี้ได้
    if (!in_array($current_role, ['admin', 'manager', 'committee'])) {
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasLabel">
    ...
    <div class="offcanvas-body sidebar">
      ...
      <nav class="sidebar-menu">
        <a href="admin_dashboard.php" class="active"><i class="fa-solid fa-border-all"></i>แดชบอร์ด</a>
